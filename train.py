"""
Autoresearch-metal pretraining script. Single-GPU, single-file.
Apple Silicon (MPS) adaptation of karpathy/autoresearch.
...
if device_type == "mps" and not torch.backends.mps.is_built():
    print("Warning: PyTorch not built with MPS support. Falling back to CPU.")
...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x, ve, cos_sin, window_size):
        ...
        # PyTorch SDPA (no FlashAttention-3 dependency)
